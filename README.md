...
review — then runs a single pre-PR review gate that combines the consolidated review
with the build/test/lint checks.
...
- `/crew:pr` — push the branch and open a pull request
