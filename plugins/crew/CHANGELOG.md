...
- **`morpheus`'s writes are lane-guarded**: Edit/Write only on `.claude/`, scratch, and the plan
  and ledger files under the plan directory. It never wrote production code; the hook now
