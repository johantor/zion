...
tools: Read, Edit, Write, Grep, Glob, Bash, ToolSearch, Skill, mcp__figma, mcp__figma-desktop, mcp__claude_ai_Figma, mcp__Figma, mcp__playwright, mcp__chrome-devtools, mcp__context7, mcp__plugin_figma_figma, mcp__plugin_figma-desktop_figma-desktop, mcp__plugin_playwright_playwright, mcp__plugin_chrome-devtools_chrome-devtools, mcp__plugin_context7_context7
model: sonnet
maxTurns: 72
color: cyan
memory: local
