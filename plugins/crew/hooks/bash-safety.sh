...
# is and what to hand back; any other git gets the generic refusal. seraph and
# sentinel carry no Bash tool, so they need no entry.
...
case "$agent_type" in
  tank|trinity|oracle|dozer|neo|keymaker)
