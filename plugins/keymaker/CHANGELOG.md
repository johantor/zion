...
- `debt-taxonomy` skill — suppression mechanisms for .NET/C# and TypeScript/JS, upgrade tiers (tier 1: single-package; tier 2: platform migration → outline only), classification rubric, blast-radius gate, batch commit shapes, handoff outline format, and package-manager variance notes.
